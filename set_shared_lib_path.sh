...
if [[ $DEV_NICKNAME == "Asus_Win7_VBox_Ubuntu_20_04_LTS" ]]; then
    ...
    S_BOOST_LIBRARYDIR="${S_MY_BOOST_HOME_DIR}/lib"
    # Setting up python (2024-06-23 19:12), using python provided by msys2
	S_MY_MINGW64_HOME="/d/procs/msys64/mingw64"
    S_Python3_INCLUDE_DIRS="${S_MY_MINGW64_HOME}/include/python3.10"
    S_Python3_LIBRARY="${S_MY_MINGW64_HOME}/lib"
    S_Python3_LIBRARIES="${S_MY_MINGW64_HOME}/lib/libpython3.10.dll.a"
